...
1055 E Evelyn Ave     & \textit{E-mail:} \email{prv@cise.ufl.edu}\\
Sunnyvale, CA  94087 USA    & \textit{WWW:}
...
\item[] M.S.,
        ...
        \begin{innerlist}
        \item Thesis Topic: \emph{Palantir -- CrowdSourced Newsification Using Twitter}
        \item Adviser:
...
%
\textbf{\href{http://www.linkedin.com/}LinkedIn},
Mountain View, CA USA
\begin{outerlist}

\item[] \textit{Software Developer Intern}%
        \hfill \textbf{May 2012 ~-- August 2012}
\begin{innerlist}
\item Engineered new APIs to support sponsored job listings and updated customer facing webpages to make use of the new functionality
\end{innerlist}
...
%\item[] \textit{}%
%         \hfill \textbf{May 2012 ~-- August 2012}
\item[] \textit{Palantir: CrowdSourced Newsification Using Twitter}
\begin{innerlist}
\item Envisioned a system exploiting Twitter as a source \& sink for breaking news
\item Built a tag recommender, which suggests on avg. $2.5$ useful tags per Tweet.
\item \textsl{Technology}: Python, Amazon Mechanical Turk, Natural Language Tookit, Twitter API, Bing API, matplotlib, \LaTeX{}, \BibTeX{}
\end{innerlist}
...
%    \hfill \textbf{September 2007~-- August 2009}
    ...
    \begin{innerlist}
        ...
        \begin{innerlist}
            \item Compared different topic modeling toolkits, feedback mechanisms
            \item \textsl{Technology}: Mallet NLP Framework, PHP, CSS, Google Maps API
        \end{innerlist}
	\end{innerlist}
        \halfblankline
        ...
        \begin{innerlist}
            ...
            \item \textsl{Technology}: Google Earth KML generation, MySQL, bash scripting, matplotlib
        \end{innerlist}
	\end{innerlist}
        \halfblankline
...
%    \hfill \textbf{September 2007~-- August 2009}
    ...
    \begin{innerlist}
        ...
        \begin{innerlist}
            ...
            \item \textsl{Technology}: Objective C, MySql, Java
        \end{innerlist}
	\end{innerlist}
        \halfblankline
...
% Information/Internet \textsl{Technology}:
% %
% \begin{innerlist}
